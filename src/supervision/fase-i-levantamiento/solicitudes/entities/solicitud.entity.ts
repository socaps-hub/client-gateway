...
import { EvaluacionFase2 } from 'src/supervision/fase-ii-seguimiento/evaluaciones-fase2/entities/evaluacion-fase2.entity';
import { EvaluacionResumenFase2 } from 'src/supervision/fase-ii-seguimiento/evaluaciones-fase2/resumen-fase2/entities/evaluacion-resumen-fase2.entity';
import { EvaluacionFase3 } from 'src/supervision/fase-iii-desembolso/evaluaciones-fase3/entities/evaluacion-fase3.entity';
import { EvaluacionResumenFase3 } from 'src/supervision/fase-iii-desembolso/evaluaciones-fase3/resumen-fase3/entities/resumen-fase3.entity';
